...
## Tasks Checklist
- [ ] TASK-002-01: Define `User` model (email, api_key, status, timestamps) (Effort: 4h)
- [ ] TASK-002-02: Define `File` model (cid, user_id, pin_status, timestamps) (Effort: 3h)
- [ ] TASK-002-03: Define `AuditLog` model (user_id, action, details, ts) (Effort: 3h)
- [ ] TASK-002-04: Configure Alembic and initial migration (Effort: 6h)
